...
{
    printf("%s -- This command can be used to multicast client configure.\n", prog_name);
    printf("Usage:\n");
    printf("    multic_config_admin  -R\n");
    printf("    multic_config_admin  -H \n");
    printf("Options:\n");
...
int main(int argc, char **argv)
{
	...
	switch(cmd){
		case TMCC_APP_CMD_RECOVER:
            ret = multi_client_config_recover();
            break;
        default:
            print_usage();
            return 0;
